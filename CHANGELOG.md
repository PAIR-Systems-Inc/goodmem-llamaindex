...
- Convert vector scores to LlamaIndex's higher-is-better direction while retaining raw scores and their kind in metadata. Reranker scores are unchanged. Cover all four query-fusion modes and the standard similarity postprocessor.
